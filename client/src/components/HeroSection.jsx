...
const heroSlides = [
  ...
  },
  {
    ...
    duration: "2hr 13min",
    description:
      "Peter Parker balances his life as an ordinary high school student in Queens with his superhero alter ego Spider-Man, facing the Vulture as his first major threat.",
    logo: "/MarvelLogo.png",
  ...
  },
   {
    ...
    duration: "1hr 55min",
    description:
      "After a tragic accident, Dr. Stephen Strange learns the secrets of a hidden world of mysticism and alternate dimensions, becoming the Sorcerer Supreme.",
    logo: "/MarvelLogo.png",
          ...
          <div className="relative h-screen w-full">
            ...
            <div className="absolute inset-0 flex flex-col items-start justify-center gap-8 px-10 md:px-14 lg:px-23">
              <div className="flex flex-col items-start justify-center max-md:text-sm mt-10 min-2xl:text-xl">
                ...
                <h1 className='text-5xl leading-18 max-w-120 font-semibold li mx-2 max-md:text-3xl max-md:leading-10'>
                  {slide.title}
                </h1>
