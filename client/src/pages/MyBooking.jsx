...
const MyBooking = () => {
  ...
  return bookings.length > 0 ? (
    <div className="relative mt-20 px-4 sm:px-6 md:px-14 lg:px-24 pt-10 min-h-[70vh] mb-10 max-md:mt-15">
      ...
      <h1 className="text-lg sm:text-xl font-medium text-gray-300 mb-6">
        Your Bookings
      </h1>
            ...
            >
              <div className="flex gap-4">
                ...
                <div className="flex flex-col justify-between text-white text-sm">
                  ...
                  <p className="text-md">
                    {formatDateTime(data.show.showDateTime)}
                  </p>
                </div>
              </div>
    ...
    <div className="flex items-center justify-center text-gray-400 min-h-screen text-4xl max-md:text-3xl font-semibold">
      No bookings found
    </div>
  );
};
